    ...
    <section id="portfolio" class="portfolio">
        <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        ...
                        <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li data-filter="<?php echo e('.filter-' . $kategori->kategori_slug); ?>"><?php echo e($kategori->kategori); ?></li>
            ...
            <div class="row portfolio-container">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item <?php echo e('filter-' . $p->kategori->kategori_slug); ?>">
                    <div class="portfolio-wrap">
                        <img src="<?php echo e(asset( 'code/public/storage/portofolio/' . $p->gambar)); ?>" class="img-fluid" alt="">
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
