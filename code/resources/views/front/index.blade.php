    ...
    <section id="about" class="about">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 d-lg-flex d-md-none order-lg-1 content justify-content-center about-img" data-aos="fade-left">
                    <img src="{{ asset('assets/techie/img/example-final.jpg') }}" draggable="false" class="img-fluid" width="70%" alt="">
                </div>
            </div>
    ...
    <section id="services" class="services section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-3 col-md-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                ...
                <div class="col-lg-3 col-md-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <img src="{{ asset('assets/techie/img/testimonials/testimonials-1.jpg') }}"
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <img src="{{ asset('assets/techie/img/testimonials/testimonials-2.jpg') }}"
                                class="testimonial-img" alt="">
                            <h3>Sara Wilsson</h3>
                            <h4>Designer</h4>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <img src="{{ asset('assets/techie/img/testimonials/testimonials-3.jpg') }}"
                                class="testimonial-img" alt="">
                            <h3>Jena Karlis</h3>
                            <h4>Store Owner</h4>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <img src="{{ asset('assets/techie/img/testimonials/testimonials-4.jpg') }}"
                                class="testimonial-img" alt="">
                            <h3>Matt Brandon</h3>
                            <h4>Freelancer</h4>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <img src="{{ asset('assets/techie/img/testimonials/testimonials-5.jpg') }}"
                                class="testimonial-img" alt="">
                            <h3>John Larson</h3>
                            <h4>Entrepreneur</h4>
                        </div>
            ...
            <div class="row portfolio-container">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/techie/img/portfolio/portfolio-1.jpg') }}"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/techie/img/portfolio/portfolio-2.jpg') }}"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/techie/img/portfolio/portfolio-3.jpg') }}"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/techie/img/portfolio/portfolio-4.jpg') }}"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/techie/img/portfolio/portfolio-5.jpg') }}"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/techie/img/portfolio/portfolio-6.jpg') }}"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/techie/img/portfolio/portfolio-7.jpg') }}"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/techie/img/portfolio/portfolio-8.jpg') }}"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/techie/img/portfolio/portfolio-9.jpg') }}"
                                data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i
                                    class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
